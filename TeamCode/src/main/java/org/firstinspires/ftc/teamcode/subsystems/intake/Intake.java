...
public class Intake {
    ...
    public enum Value implements Command {
        START (0, INIT,0),
        OUTTAKE (500, DOWN,-0.65),
        INTAKE  (1000, DOWN,0.65),
        INTAKEMORE(2000,DOWN,0.6),
        STOP    (0,UP,0),
        SAMPLE(250,UP,0);
        ...
        public final double horizontalSlide, rPos, intakePower;
        ...
        switch(value) {
            case OUTTAKE:
                return new SequentialCommandGroup(
                    ...
                    new InstantCommand(()-> intakeServo.setSetPoint(value.rPos)),
                    new WaitCommand(500),
