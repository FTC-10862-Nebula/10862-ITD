...
public class ProjectDrive extends MecanumDrive {
    ...
    private static final TrajectoryVelConstraint VEL_CONSTRAINT = getVelocityConstraint(MAX_VEL, MAX_ANG_VEL, TRACK_WIDTH);
...
//    private final BNO055IMU imu;
    ...
    public ProjectDrive(HardwareMap hardwareMap, Telemetry telemetry) {
