...
//    public IntakeDefaultCommand(Intake intake, Outtake outtake, SensorColor sensorColor, Intake.Sample lookFor) {
...
//                    ()-> (noLookFor == sensorColor.getSampleColors())
//                ),
//                ()-> (lookFor == sensorColor.getSampleColors()) ||
